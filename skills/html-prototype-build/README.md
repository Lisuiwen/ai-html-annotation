...
Installation, product demo, and repository-level overview live in the [repository README](../../README.md). Product docs (guide, quickstart, UI packs) live in [`docs/`](../../docs/README.md). This file covers how to use the Skill; concrete commands and step-by-step operations live in `references/`.
...
| Product guide, quickstart, UI packs | [Product docs](../../docs/README.md) |
