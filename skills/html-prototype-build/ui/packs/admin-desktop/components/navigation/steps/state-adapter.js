/* Steps local state projection: reflects current step and flow state provided by the page only. */
(function () {
  'use strict'; var adapters = window.PrototypeUiAdapters = window.PrototypeUiAdapters || {};
  /* Restrict step status set. */
  ...
  /* Sync step status and current step assistive semantics. */
