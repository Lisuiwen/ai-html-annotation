/*
 * 原型正式标注唯一数据源；由 Notes Editor 通过作者服务维护。
...
window.__PROTOTYPE_NOTES__ = {
  ...
  "scenarios": {
    ...
    "create": {
      "extends": "base",
      "state": { "product": { "layers": ["create"] } }
    },
    "edit": {
      "extends": "base",
      "state": { "product": { "layers": ["edit"] } }
    },
    "strategy": {
      "extends": "base",
      "state": { "product": { "layers": ["strategy"] } }
    }
  },
  "header": {
    "title": "功能说明",
  ...
  "cards": [
    {
      "id": "filter-area",
      "when": { "product.page": "list", "product.layers": [] },
      "title": "配置项查询",
    ...
    {
      "id": "create-form",
      "when": { "product.page": "list", "product.layers": ["create"] },
      "title": "新建字段",
    ...
    {
      "id": "edit-form",
      "when": { "product.page": "list", "product.layers": ["edit"] },
      "title": "编辑字段",
    ...
    {
      "id": "strategy-name",
      "when": { "product.page": "list", "product.layers": ["strategy"] },
      "title": "任务关联配置项",
