...
window.__PROTOTYPE_NOTES__ = {
  ...
  "header": {
    "title": "功能说明",
    "subtitle": "按列表、新建、编辑与车型策略状态展示"
  },
  "overview": {
    "title": "前置条件统一维护",
    "body": "在系统管理下新增前置条件维护入口，支持查询、新建、编辑和删除；车型升级策略的新建条件名称改为从已维护前置条件中选择。"
  },
  "cards": [
    {
      "id": "filter-area",
      "group": "base",
      "title": "条件查询",
      "body": "可按前置条件名称、编码筛选；重置清空当前筛选值，查询刷新列表结果。",
      "target": {
    ...
    },
    {
      ...
      "group": "base",
      "title": "新建前置条件",
      "body": "点击“新建”打开维护弹窗，名称和编码为必填项，描述可选。",
      "target": {
    ...
    {
      "id": "menu-precondition",
      "group": "base",
      "title": "新增菜单入口",
      "body": "在系统管理下增加“前置条件”菜单，进入统一维护列表。",
      "target": {
        "selector": "[data-prototype-note-target=\"menu-precondition\"]",
        "label": "前置条件"
      }
    },
    {
      ...
      "group": "create",
      "title": "新建字段",
      "body": "名称、编码限制不超过 36 个字符；提交后新增前置条件。",
      "target": {
    ...
    },
    {
      ...
      "group": "strategy",
      "title": "车型策略引用前置条件",
      "body": "车型升级策略新建条件时，名称不再自由输入，改为下拉选择前置条件维护列表中的名称。",
      "target": {
