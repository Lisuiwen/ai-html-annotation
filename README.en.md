...
> Turn HTML prototypes into interfaces you can annotate, review, and edit with AI.
...
HTML Prototype Build reconnects that loop with native HTML: build pages from a UI pack, annotate and review on the real DOM, copy instructions to an AI, and jump from a locked element back to source. **The page is the deliverable, not just a picture of one.**
